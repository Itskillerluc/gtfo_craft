...
public class RenderSmallCharger extends GeoEntityRenderer<EntitySmallCharger> {
    public RenderSmallCharger(RenderManager renderManager) {
        super(renderManager, new ModelSmallCharger());
    }
}
