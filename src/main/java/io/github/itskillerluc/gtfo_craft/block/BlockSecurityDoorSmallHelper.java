...
public class BlockSecurityDoorSmallHelper extends BlockDoorHelper implements ITileEntityProvider {
    ...
    public BlockSecurityDoorSmallHelper(Material blockMaterialIn, MapColor blockMapColorIn) {
        ...
        setRegistryName(new ResourceLocation(GtfoCraft.MODID, "security_door_small_helper"));
        setUnlocalizedName("security_door_small_helper");
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityDoorHelper) {
            BlockSecurityDoorSmallController.breakDoor(worldIn, ((TileEntityDoorHelper) worldIn.getTileEntity(pos)).master, state.getValue(FACING).getOpposite());
        }
