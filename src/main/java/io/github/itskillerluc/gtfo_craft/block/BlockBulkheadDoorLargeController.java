...
public class BlockBulkheadDoorLargeController extends Block implements ITileEntityProvider {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        ...
        if (blockIn != this && (flag || blockIn.getDefaultState().canProvidePower()) && flag != iblockstate1.getValue(POWERED))
        {
            ...
            {
                if (worldIn.getTileEntity(pos) instanceof TileEntityBulkheadDoorLarge && worldIn.getTileEntity(pos) != null) {
                    ((TileEntityBulkheadDoorLarge) worldIn.getTileEntity(pos)).open();
