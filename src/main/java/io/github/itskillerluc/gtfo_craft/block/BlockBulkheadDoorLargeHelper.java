...
public class BlockBulkheadDoorLargeHelper extends BlockDoorHelper implements ITileEntityProvider {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityDoorHelper) {
            BlockBulkheadDoorLargeController.breakDoor(worldIn, ((TileEntityDoorHelper) worldIn.getTileEntity(pos)).master, state.getValue(FACING).getOpposite());
        }
