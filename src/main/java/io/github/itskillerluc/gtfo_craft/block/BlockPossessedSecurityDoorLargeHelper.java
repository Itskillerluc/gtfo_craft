...
public class BlockPossessedSecurityDoorLargeHelper extends BlockDoorHelper implements ITileEntityProvider {
    ...
    public BlockPossessedSecurityDoorLargeHelper(Material blockMaterialIn, MapColor blockMapColorIn) {
        super(blockMaterialIn, blockMapColorIn);
        setCreativeTab(GtfoCraftCreativeTab.INSTANCE);
        setRegistryName(new ResourceLocation(GtfoCraft.MODID, "possessed_security_door_large_helper"));
        setUnlocalizedName("possessed_security_door_large_helper");
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityDoorHelper) {
            BlockPossessedSecurityDoorLargeController.breakDoor(worldIn, ((TileEntityDoorHelper) worldIn.getTileEntity(pos)).master, state.getValue(FACING).getOpposite());
        }
