...
public class BlockPossessedSecurityDoorSmallHelper extends BlockDoorHelper implements ITileEntityProvider {
    ...
    public BlockPossessedSecurityDoorSmallHelper(Material blockMaterialIn, MapColor blockMapColorIn) {
        ...
        setUnlocalizedName("possessed_security_door_small_helper");
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (worldIn.getTileEntity(pos) instanceof TileEntityDoorHelper) {
            BlockPossessedSecurityDoorSmallController.breakDoor(worldIn, ((TileEntityDoorHelper) worldIn.getTileEntity(pos)).master, state.getValue(FACING).getOpposite());
        }
