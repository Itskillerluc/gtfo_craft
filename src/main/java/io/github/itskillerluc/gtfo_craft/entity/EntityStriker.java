...
public class EntityStriker extends EntityMob implements IAnimatable {
    ...
    class StrikerAttackGoal extends EntityAIAttackMelee {
        private EntityStriker entity;
        private int animCounter = 0;
        private int animTickLength = 20;

        public StrikerAttackGoal(EntityStriker pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
