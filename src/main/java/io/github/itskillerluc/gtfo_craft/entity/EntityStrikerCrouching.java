...
public class EntityStrikerCrouching extends ModEntity implements IAnimatable, gtfoEntity {
    ...
    private static final DataParameter<Boolean> ATTACKING =
            EntityDataManager.createKey(EntityStrikerCrouching.class, DataSerializers.BOOLEAN);

    public EntityStrikerCrouching(World worldIn) {
        super(worldIn);
        setSize(1.2f, 1.5f);
    }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(5, new EntityAITongue<>(this, 1, false, 4, 30, ((int) EntityStatConfig.getAttackSpeed("striker_crouching")), 20, 12));
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(EntityStatConfig.getMaxHealth("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(EntityStatConfig.getFollowRange("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(EntityStatConfig.getKnockBackResistance("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(EntityStatConfig.getMovementSpeed("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(EntityStatConfig.getAttackDamage("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(EntityStatConfig.getArmor("striker_crouching"));
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR_TOUGHNESS).setBaseValue(EntityStatConfig.getArmorToughness("striker_crouching"));
    }
