...
public class EntityBigShadowShooter extends ModEntity implements IAnimatable, gtfoEntity {
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(5, new EntityAITongue<EntityBigShadowShooter>(this, 1, false, 12, 30, ((int) EntityStatConfig.getAttackSpeed("big_shadow_shooter")), 20, 17) {
            @Override
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(EntityStatConfig.getMaxHealth("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(EntityStatConfig.getFollowRange("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(EntityStatConfig.getKnockBackResistance("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(EntityStatConfig.getMovementSpeed("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(EntityStatConfig.getAttackDamage("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR).setBaseValue(EntityStatConfig.getArmor("big_shadow_shooter"));
        this.getEntityAttribute(SharedMonsterAttributes.ARMOR_TOUGHNESS).setBaseValue(EntityStatConfig.getArmorToughness("big_shadow_shooter"));
    }
