...
public class EntityBigShadowCharger extends ModEntity implements IAnimatable, gtfoEntity {
    ...
    private static final AnimationBuilder SLEEPING_1 = new AnimationBuilder().addAnimation("charger_default_sleeping", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SLEEPING_2 = new AnimationBuilder().addAnimation("charger_sleeping_1", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SLEEPING_3 = new AnimationBuilder().addAnimation("charger_sleeping_2", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder IDLE = new AnimationBuilder().addAnimation("charger_default_idle", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder RUN = new AnimationBuilder().addAnimation("charger_run", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder TONGUE_ATTACK = new AnimationBuilder().addAnimation("charger_tongue_attack", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SCREAM_1 = new AnimationBuilder().addAnimation("charger_scream_1", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SCREAM_2 = new AnimationBuilder().addAnimation("charger_scream_2", ILoopType.EDefaultLoopTypes.LOOP);
    private static final AnimationBuilder SCREAM_3 = new AnimationBuilder().addAnimation("charger_scream_3", ILoopType.EDefaultLoopTypes.LOOP);
    ...
    private static final DataParameter<Boolean> ATTACKING =
            EntityDataManager.createKey(EntityBigShadowCharger.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> TONGUE_ATTACKING =
            EntityDataManager.createKey(EntityBigShadowCharger.class, DataSerializers.BOOLEAN);

    public EntityBigShadowCharger(World worldIn) {
        super(worldIn);
        setSize(1.6f, 4f);
    }
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(4, new AnimatedAttackGoal<EntityBigShadowCharger>(this, 1, true, 30) {
            @Override
            public boolean shouldExecute() {
                return super.shouldExecute() && getDistanceSq(getAttackTarget()) < 30;
            }
